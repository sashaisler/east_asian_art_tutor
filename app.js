const STUDY_ITEMS = [
  ...
  },
  {
    ...
    date: '1160–1225, Song Dynasty',
    period: '',
    medium: 'ink and color on silk',
    maker: 'Ma Yuan',
    importance: 'Shows Ma Yuan’s “one-corner” composition, where the main figure, tree, and path are pushed to one side while the rest is left open and atmospheric. The painting creates a quiet poetic mood and shows the Southern Song interest in intimate, lyrical landscapes rather than huge monumental mountains.',
  },
  {
    id: 40,
    ...
    maker: 'Attributed to Toba Sōjō, but could have been other artists',
    importance: 'Famous Japanese narrative handscroll showing animals acting like people. It is important for its playful satire, lively brushwork, and early use of sequential storytelling that is sometimes connected to later manga traditions.',
  },
  {
    id: 41,
    ...
    medium: '',
    maker: '',
    importance: 'No metadata was provided for this slide in the CSV.',
  },
  {
    id: 42,
    title: 'Night Attack on the Sanjō Palace',
    date: 'Kamakura period, 13th century',
    period: '',
    medium: 'Handscroll, ink and color on paper',
    maker: '',
    importance: 'Famous Japanese war tale painting; dramatic use of fire, crowd movement, and narrative action.',
  },
  {
    id: 43,
    title: 'A Thousand Peaks and Myriad Ravines',
    date: 'Qing dynasty, 17th century',
    period: '',
    medium: 'Hanging scroll, ink on paper',
    maker: 'Gong Xian',
    importance: 'Shows Gong Xian’s dense, layered ink style, using repeated brushstrokes and dark ink buildup to create heavy mountains and deep space. It reflects early Qing individualist painting and a mood of withdrawal after the fall of the Ming dynasty.',
  },
  {
    id: 44,
  ...
  },
  {
    ...
    date: 'Edo period, early 18th century',
    period: '',
    medium: 'folding screens, ink, color, and gold on paper',
    maker: 'Ogata Kōrin',
    importance: 'Famous Rinpa-style screen painting based on a scene from The Tales of Ise. The repeated irises and angular bridge create a decorative rhythm across the gold background, showing how literature, design, and painting could be combined in Edo-period Japanese art.',
  },
  {
    id: 48,
    title: 'Wood and Rock',
    date: 'Northern Song dynasty, 11th century',
    period: '',
    medium: 'Handscroll, ink on paper',
    maker: 'Su Shi',
    importance: 'Important early example of literati painting. Instead of trying to look realistic, the painting uses rough, calligraphic brushwork to show the artist’s personality and scholarly values. It helped establish the idea that painting could be like poetry and calligraphy: a form of personal expression.',
  },
  {
    id: 49,
  ...
  },
  {
    ...
    date: 'Yuan dynasty, 1296',
    period: '',
    medium: 'Handscroll, ink and color on paper',
    maker: 'Zhao Mengfu',
    importance: 'Important literati landscape painting made for a friend who had never seen his ancestral home near the Qiao and Hua mountains. It is not meant to be fully realistic; instead, Zhao uses intentionally old-fashioned forms, soft colors, and calligraphic brushwork to connect painting with memory, history, and personal meaning.',
  },
  {
    id: 52,
    title: 'Portrait of Minamoto no Yoritomo',
    date: 'Kamakura period, 1179',
    period: '',
    medium: 'Hanging scroll, ink and color on silk',
    maker: 'Attributed to Fujiwara no Takanobu',
    importance: 'Important example of Kamakura-period portraiture and the growing power of the warrior class in Japan. The portrait presents Yoritomo as a serious, controlled military leader, using realistic facial features, formal clothing, and a reserved pose to emphasize authority and status.',
  },
  {
    id: 53,
  ...
  {
    id: 58,
    title: 'Funerary Urn / Hunping, “Urn of the Soul”',
    date: 'Western Jin dynasty, 265–316 CE',
    period: '',
    medium: 'Glazed stoneware, probably Yue ware celadon',
    maker: 'Unknown Chinese potter',
    importance: 'Important tomb object made for the afterlife. The crowded upper section shows architecture, figures, animals, and ritual scenes, creating a miniature world for the soul. It reflects early Chinese beliefs about death, immortality, and the connection between burial objects and the afterlife.',
  },
  {
    id: 59,
  ...
  },
  {
    ...
    importance: 'Important Confucian ritual building used to house spirit tablets of Joseon kings and queens. Its long, simple, horizontal design reflects Joseon values of order, restraint, ancestry, and state ritual. It is part of Jongmyo Shrine, one of the most important royal ancestral shrines in Korea.',
  },
  {
    id: 61,
  ...
  },
  {
    ...
    period: '',
    medium: 'Celadon-glazed stoneware with openwork design',
  ...
  },
  {
    ...
    medium: 'Hanging scroll, ink on paper',
    maker: 'Sesshū Tōyō',
    importance: 'Important Zen painting showing the dramatic story of Huike proving his dedication to Bodhidharma by cutting off his arm. Sesshū uses rough, expressive ink brushwork and a stark composition to emphasize spiritual intensity, discipline, and the direct transmission of Zen teaching.',
  },
  {
    id: 67,
    title: 'Flowers and Insects, double-check exact title',
  ...
  },
  {
    ...
    period: '',
    medium: 'Handscroll or hanging scroll, ink and color on paper/silk',
    maker: 'Shen Zhou',
  ...
  },
  {
    ...
    period: '',
    medium: 'Album leaves, ink and light color on paper or silk',
    maker: 'Jeong Seon',
  ...
  },
  {
    ...
    period: '',
    medium: 'Ink on paper',
    maker: 'Prince Anpyeong / Anpyeong-daegun',
  ...
  },
  {
    ...
    medium: 'Hanging scroll, ink on paper',
    maker: 'Dong Qichang',
    importance: 'Important Ming literati landscape based on earlier Chinese landscape traditions, especially Wang Meng’s Qingbian Mountain theme. Dong Qichang uses layered, abstract mountain forms and soft brushwork to show that painting is not just about copying nature, but about studying and transforming earlier masters. It reflects his major role as both a painter and art theorist in later Chinese literati painting.',
  },
];
const IMAGE_MAP = {
